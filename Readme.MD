...
|                  | [向量存储IVectorStore](/core/vector_store)                                   | 向量集合管理接口，支持 Top-K 相似度检索，为 AI 应用提供向量检索基础设施。 |
...
|                  | [HTTP服务端HttpServer（嵌入式设备）](https://newlifex.com/core/httpserver)   | 轻量级Http服务器，支持中间件管道、参数化路由与静态文件服务。 |
